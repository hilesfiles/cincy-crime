...
export function TrendAnalysis({ historical }: { historical: HistoricalData }) {
  ...
  const unit = measure === "rate" ? "per 1,000 using the annual denominator series" : measure === "yoy" ? "year-over-year percent" : "reported offenses";
