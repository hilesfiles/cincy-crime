...
const links = [["Explore", "/"], ["Rankings", "/rankings"], ["Compare", "/compare"], ["Trends", "/trends"], ["Demographics", "/demographics"], ["Elections", "/elections"], ["Financials", "/budget"], ["Methodology", "/methodology"], ["Data status", "/data-status"]] as const;
