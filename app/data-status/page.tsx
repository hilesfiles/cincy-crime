...
import historical from "@/data/reports/historical-validation.json";
...
export default function DataStatusPage() { const summary = summaryJson as CrimeSummary; const stars = starsJson as CrimeSummary; const rows = [
  ...
  ["Historical annual panel", "2011–present", historical.status, `${historical.annualYears.length} calendar years enabled; same-date YTD comparisons through ${historical.sameDateYtdYears.at(-1)}; unresolved rows retained explicitly`],
