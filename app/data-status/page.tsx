...
export default function DataStatusPage() {
  ...
  const latestArtifact = [summary.metadata.retrievedAt, stars.metadata.retrievedAt, cpdReports.generatedAt, population.generatedAt, demographics.generatedAt, elections.metadata.generatedAt, budget.metadata.generatedAt, transition.generatedAt, unmapped.generatedAt, historical.metadata.generatedAt, validationSummary.generatedAt].sort().at(-1)!;
