...
export default function ComparePage() { const summary = summaryJson as CrimeSummary; const historical = historicalJson as HistoricalData; return <PageShell eyebrow="Side-by-side analysis" title="Compare statistical areas" description="Compare up to four areas by aggregate or discrete offense type in the current YTD window or any validated calendar year from 2011–2025."><ComparisonTool currentSummary={summary} historical={historical} /></PageShell>; }
