...
async function main() {
  ...
  insertSource.run("CPD_NEIGHBORHOOD_REPORTS", "CPD_REPORTS", "Cincinnati Police Department", "Neighborhood Reports", "cpdmobile-neighborhood-reports", "https://cpdmobile.cincinnati-oh.gov/Neighborhoods/default.html", "Verify before redistribution", "Fresher preliminary aggregate layer; 51 civic reports are aggregated to 50 CAGIS features using the versioned crosswalk.");
  insertSource.run("CITY_PLANNING_2020_SNA_PROFILES", "DEMOGRAPHICS", "City of Cincinnati Department of City Planning and Engagement", "2020 Statistical Neighborhood Approximations", "planning-2020-sna-profiles", "https://www.cincinnati-oh.gov/planning/resources/census/2020/", "Verify before redistribution", "Official 2020 neighborhood-profile population denominators; direct Citywide profile is used for the citywide rate.");
